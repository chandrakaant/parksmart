...
@Configuration
@EnableSwagger2
@ComponentScan( basePackages = "com.ckp.parksmart.controller" )
public class SwaggerConfig {

    private static final String SWAGGER_API_VERSION = "1.0";
    private static final String LICENSE_TEXT = "License";
    private static final String title = "CKP REST API";
    private static final String description = "RESTful API for PARKSMART";
